...
<div class="w3-containerx" id="contact">
    <div class="w3-content w3-container w3-padding-16" style="max-width:600px">
		...
		<form action="" method="post" class="w3-padding"  enctype = "multipart/form-data" >			
			...
			<div class="w3-section" >
				Spotify Profile
				<textarea rows="4" class="w3-input w3-border w3-padding w3-round-xlarge" name="spotify" placeholder="spotify" required><?PHP echo $data["spotify"];?></textarea>
			</div>
			...
			<div class="w3-row w3-large">
				<div class="w3-col  s6">
					<a href="profile.php"><i class="fa fa-fw fa-arrow-circle-left fa-3x"></i></a>
				</div>
				<div class="w3-col  s6">
