...
<div class="w3-containerx" id="contact">
    <div class="w3-content w3-container w3-padding-16" style="max-width:600px">
			...
			<div class="w3-padding" >
				<b>Password</b><br>
				<div class="w3-input w3-light-grey w3-round-large w3-border" type="password"><?php echo str_repeat('*', strlen($data["password"])); ?></div>
			</div>
...
<div class="w3-bottom w3-padding">
	<div class="w3-content w3-padding" style="max-width:600px">
		<div class="w3-row w3-large w3-padding-16 ">
			...
			<div class="w3-col  s6">
				<a href="profile-edit.php" class="w3-right w3-padding w3-button w3-round-xlarge w3-lightbrown">Update Profile <i class="fa fa-fw fa-edit"></i></a>
			</div>
		</div>
	</div>
</div>
